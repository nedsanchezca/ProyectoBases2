...
CREATE VIEW V_REPVENTAS_CLAS_REG AS SELECT RV.F_TIPO_ID,RV.F_NUMERO_ID,HC.F_ID_CLASIFICACION,RV.F_CODIGO_POSTAL
    FROM REP_VENTAS RV,HISTORICO_CLASIFICACION HC
    WHERE RV.F_TIPO_ID = HC.F_TIPO_ID
    AND RV.F_NUMERO_ID = HC.F_NUM_ID
    AND D_FECHA_FINAL = (SELECT MAX(D_FECHA_FINAL) 
                        FROM HISTORICO_CLASIFICACION H
                        WHERE RV.F_TIPO_ID = H.F_TIPO_ID
                        AND RV.F_NUMERO_ID = H.F_NUM_ID);