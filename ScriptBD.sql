...
begin
	EXECUTE IMMEDIATE 'DROP TABLE   "producto_categoria" CASCADE CONSTRAINTS';
	EXCEPTION WHEN OTHERS THEN NULL;
end;  
/
...
COMMENT ON TABLE  "producto_categoria" IS 'Tabla de rompimiento entre producto y categoria'
;

COMMENT ON COLUMN  "producto_categoria"."K_ID" IS 'Identificador de la tabla de rompimiento'
;

COMMENT ON COLUMN  "producto_categoria"."F_CODIGO_PRODUCTO" IS 'Llave foranea con el identificador del producto'
;

COMMENT ON COLUMN  "producto_categoria"."F_ID" IS 'Lllave foranea de la subcategoria'
;
...
ALTER TABLE  "producto_categoria" 
 ADD CONSTRAINT "FK_producto_categ_categoria_01"
	FOREIGN KEY ("F_ID") REFERENCES  "categoria" ("K_ID")
;
