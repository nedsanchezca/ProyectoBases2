 ...
 */
public class cambiarRepVentas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        repDAO.cambiarRepresentante(cli);
        request.getSession().setAttribute("anterior", "pagina_Lobby.jsp");
        request.getSession().setAttribute("mensajeError", repDAO.cambiarRepresentante(cli).getMensaje());
